...
cp /lib/arm-linux-gnueabihf/*nss* /usr/local/$CARPETA/lib/arm-linux-gnueabihf/
cp -r /usr/lib/sudo /usr/local/$CARPETA/usr/lib/
cp -r /lib/arm-linux-gnueabihf/* /usr/local/$CARPETA/usr/lib/arm-linux-gnueabihf/
cp -r /etc/ld.so* /usr/local/$CARPETA/etc
cp -r /lib/arm-linux-gnueabihf/*nss* /usr/local/$CARPETA/lib/arm-linux-gnueabihf/
cp -r /etc/pam* /usr/local/$CARPETA/etc/
cp -r /lib/arm-linux-gnueabihf/security /usr/local/$CARPETA/lib/arm-linux-gnueabihf/
cp -r /lib/arm-linux-gnueabihf/security /usr/local/$CARPETA/lib/arm-linux-gnueabihf/
cp -r /lib/arm-linux-gnueabihf/*libcap* /usr/local/$CARPETA/lib/arm-linux-gnueabihf/
cp -r /lib/arm-linux-gnueabihf/*librt* /usr/local/$CARPETA/lib/arm-linux-gnueabihf/
